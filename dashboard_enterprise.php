...
<html lang="fr-FR">
    ...
    <head>
        ...
        <title>Learn Station&reg; | Dashboard</title>
    ...
    <body>
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                ...
                <span class="logo-mini"><b>L</b>STATION</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Learn</b>STATION</span>
            </a>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-8 calendar">
                                ...
                                <div class="row">
                                    ...
                                    <!-- ./..col-xs-12 col-sm-12 col-md-6 homework -->
                                    <div class="col-xs-12 col-sm-12 col-md-6 forum">
                                        <h2>Forum</h2>
                                    </div>
                                    <!-- ./..col-xs-12 col-sm-12 col-md-6 forum -->
                                </div>
                                <!-- ./..row -->
                            </div>
                            <!-- ./..col-xs-12 col-sm-12 col-md-8 calendar -->
                            <div class="col-xs-12 col-sm-12 col-md-4 chat">
                                <h2>Chat</h2>
                            </div>
                            <!-- ./..col-xs-12 col-sm-12 col-md-4 chat -->
                        </div>
                        <!-- ./..row calendar -->
