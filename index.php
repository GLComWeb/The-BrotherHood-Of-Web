...
<html lang="fr-FR">
	<head>
		...
		<title>ApolEarn II Plateforme social et collaborative d'auto-formation</title><!-- bon affichage sur mobile -->
			...
			<nav class="navbar navbar-fixed-top custom-navbar" role="navigation">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html">ApolEarn II</a>
					</div>
					<!-- Collect the nav links, forms, and other content for toggling -->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							<li><a href="#home">Accueil <span class="sr-only">(current)</span></a></li>
							<li><a href="registration.html">Inscription<!-- | Connexion --></a></li>
		...
		<main class="container-fluid">
			...
			<section class="row" id="home">
				<div class="col-xs-12">
					...
					<hr>
					<a href="registration.html" class="btn btn-danger">Créer un compte</a>
									...
									<div class="row contactIcon">
										...
										<div class="col-sm-12 col-md-6">
											<ul class="list-inline">
												<li>
													<a href="#" class="socIcon color-primary linear" target="_blank"><i class="fa fa-facebook fa-2x"></i></a>
												</li>
												<li>
													<a href="#" class="socIcon color-primary linear" target="_blank"><i class="fa fa-twitter fa-2x"></i></a>
												</li>
												<li>
													<a href="#" class="socIcon color-primary linear" target="_blank"><i class="fa fa-linkedin fa-2x"></i></a>
												</li>
											</ul>
