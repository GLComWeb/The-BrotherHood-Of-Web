...
if ($succes) { 
    ...
    $return['erreur0'] = 'Une erreur est survenue dans l\'exécution de la requête du nombre total de sujet';
}

$requete = $db->prepare('SELECT * FROM discussion ORDER BY date_post DESC'); // LIMIT :offset, :nombreSujet
